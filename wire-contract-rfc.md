...
Branch: `observability`. Implementation: core envelope/retained helpers, dio+tags, and control landed (with conformance); washer/program/camera2d/arm/config + codegen pending.
