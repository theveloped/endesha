...
Branch: `observability`. Implementation: step 1 + table-contract pilot landed (core envelope/retained helpers, dio+tags, conformance); remaining contracts + codegen pending.
