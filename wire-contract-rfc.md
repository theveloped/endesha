...
Branch: `observability`. Implementation: core envelope/retained helpers, dio+tags, control, washer commands, the program runner, and config landed; camera2d/arm + codegen pending.
