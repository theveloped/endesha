...
Get-CimInstance Win32_Process | Where-Object { $_.CommandLine -match 'wf\.services\.supervisor|wf\.hal\.|wf\.services\.recording|wf\.services\.config|wf\.services\.program_runner|zenoh-bridge-remote-api|vite' } |
    ForEach-Object {
