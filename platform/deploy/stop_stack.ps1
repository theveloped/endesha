...
Get-CimInstance Win32_Process | Where-Object { $_.CommandLine -match 'aubo_i10|wf.hal.arm_sim|wf.hal.genicam|wf.hal.camera2d_sim|wf.services.recording|wf.services.config|zenoh-bridge-remote-api|vite' } |
    ForEach-Object {
