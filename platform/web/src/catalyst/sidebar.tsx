...
export const SidebarItem = forwardRef(function SidebarItem(
  ...
  const classes = clsx(
    ...
    // Leading icon/icon-only — outline only (colour the lucide stroke via
    // currentColor; never fill, so the glyphs read as line icons)
    '*:data-[slot=icon]:size-6 *:data-[slot=icon]:shrink-0 *:data-[slot=icon]:fill-none *:data-[slot=icon]:text-zinc-500 sm:*:data-[slot=icon]:size-5',
